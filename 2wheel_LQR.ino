...
void setup() {
 ...
 addtheta=0;
  ...
  // K5 = 0.7;
  //  K6 = 2.7;
  // K1 = 1000;  //k1*theta - goc toi   10-50
  // K2 = 1500;  //k2*thetadot - toc do di chuyen toi (8-15)
  // K3 = 37000; //k3*psi - goc nghieng      (lớn thì chạy mượt) (100-300)
  // K4 = 6000;  //k4*psidot - van toc goc nghieng  (10-20)
  // K5 = 6000;  //k5*phi  - goc quay  (10-15)
  // K6 = 50;   //k6*phidot - vantoc goc quay (0-5)
...
void loop() {
  ...
  if (Serial1.available()) { 
    ...
    Serial.println("Received command: " + String(data)); // Print the received data to Serial Monitor
  }
...
void serialEvent1() {
    if (Serial1.available()) {
        data = Serial1.read();  // Read from Serial1
